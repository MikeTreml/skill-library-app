...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::dismiss_cluster,
            commands::undismiss_cluster,
            commands::list_dismissed_clusters,
            commands::add_item_tag,
            commands::remove_item_tag,
            commands::list_item_tags,
            commands::list_all_tags,
            commands::list_uncanonical_verbs,
            commands::canonical_verbs,
            commands::recent_activity,
            commands::export_items,
            commands::set_api_key,
            commands::api_key_status,
            commands::mark_used,
            commands::deletion_candidates,
